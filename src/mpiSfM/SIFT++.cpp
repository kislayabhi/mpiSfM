...
void generate_keypoints(string image_name, string outputkey_filename)
{
	int first          = -1;
	int octaves        = -1;
	int levels         = 3;
	...
	VL::PgmBuffer buffer;
	string key_file = outputkey_filename;
	...
	out.close();
	cout << count << " points are saved to " << outputkey_filename << endl;
}
